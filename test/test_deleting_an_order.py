...
class TestFlaskApi(unittest.TestCase):
    ...
    def test_a_not_found_order(self):
        
        response = self.app.get(
            '/api/v1/orders/{}/'.format(self.nonexisting_order_id),
            content_type = "application/json"
        )
    ...
    def test_updating_nonexisting_order(self):
    ...
    def test_deleting_nonexisting_order(self):
